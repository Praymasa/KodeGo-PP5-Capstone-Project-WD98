...
import YourNeeds from "../../public/Images/tell-us.avif";
  ...
  return (
    <>
      ...
      <Box id="seniorcare" p={5}>
        <Container sx={{ backgroundColor: "#dccfdf80", p: 5 }}>
          <Typography
            variant="h4"
            className="bottom-line"
            textAlign={"center"}
          ...
          <Typography variant="body1" textAlign={"center"} marginBottom={5}>
            ...
            care plan based on their health goals. Because YBCare offers a wide
            variety of services, we are able to easily modify your care plan and
            services should your needs change.
          </Typography>
            ...
            <Grid item xs={12} md={6}>
              ...
              <Box>
                <Typography variant="body1" marginBottom={5}>
                  <Diversity2Icon color="secondary" />
                  &nbsp;{" "}
                  <b>Assistance with Activities of Daily Living (ADLs)</b>: This
                  includes help with tasks such as bathing, dressing, grooming,
                  toileting, and mobility assistance. Caregivers provide support
                  to ensure seniors can maintain their personal hygiene and
                  perform daily activities comfortably.
                </Typography>
                <Typography variant="body1" marginBottom={5}>
                  <Diversity2Icon color="secondary" />
                  &nbsp; <b>Medication Management</b>: Caregivers assist seniors
                  in managing their medications, including medication reminders,
                  organizing pillboxes, and ensuring medications are taken at
                  the prescribed times. They may also coordinate with healthcare
                  professionals to ensure proper medication administration.
                </Typography>
                <Typography variant="body1" marginBottom={5}>
                  <Diversity2Icon color="secondary" />
                ...
                <Typography variant="body1" marginBottom={5}>
                  ...
                  Caregivers can help plan and prepare nutritious meals based on
                  dietary needs and preferences. They ensure that seniors are
                  receiving proper nutrition and hydration. They may also assist
                  with feeding if necessary.
                </Typography>
                <Typography variant="body1" marginBottom={5}>
                  <Diversity2Icon color="secondary" />
                  ...
                  environment is clean, organized, and comfortable for seniors.
                </Typography>
                <Typography variant="body1" marginBottom={5}>
                  <Diversity2Icon color="secondary" />
                  &nbsp; <b>Transportation and Errands</b>: Caregivers can
                  provide transportation services, such as driving seniors to
                  medical appointments, grocery shopping, or social activities.
                  They may also assist with running errands, picking up
                  prescriptions, or accompanying seniors to important
                  appointments.
                </Typography>
              </Box>
            </Grid>
            <Grid item xs={12} md={6}>
              ...
              <Box>
                ...
                <Typography variant="body1" marginBottom={5}>
                  ...
                  specialized wound care for seniors who have wounds or ulcers.
                  They assess the wound, clean and dress it appropriately,
                  monitor healing progress, and provide ongoing care to prevent
                  infection and promote healing.
                </Typography>
                <Typography variant="body1" marginBottom={5}>
                  <Diversity2Icon color="secondary" />
                  &nbsp; <b>Chronic Disease Management</b>: Private duty nurses
                  can assist seniors with chronic conditions, such as diabetes,
                  heart disease, or respiratory disorders. They can help monitor
                  vital signs, manage symptoms, provide education on self-care,
                  and coordinate with healthcare professionals to ensure proper
                  disease management.
                </Typography>
                <Typography variant="body1" marginBottom={5}>
                  <Diversity2Icon color="secondary" />
                ...
                <Typography variant="body1" marginBottom={5}>
                  ...
                  can support seniors in their rehabilitation journey. They can
                  help with exercises, mobility assistance, and therapies
                  recommended by physical or occupational therapists. They work
                  closely with the healthcare team to facilitate the senior's
                  recovery and improve functional abilities.
                </Typography>
                <Typography variant="body1" marginBottom={5}>
                  <Diversity2Icon color="secondary" />
                  &nbsp; <b>Palliative and End-of-Life Care</b>: Private duty
                  nurses can provide compassionate care for seniors nearing the
                  end of their life or requiring palliative care. They focus on
                  pain management, symptom control, emotional support, and
                  ensuring the senior's comfort and dignity during this stage of
                  life.
                </Typography>
              </Box>
            </Grid>
